...
int cargarDesdeDatosOrdenadosRec(tArbol *p, void *dataSet,
                    unsigned (*leer)(void **, void *, unsigned, void *params,void *params2),
                    int li, int ls, void *params,void *params2);
unsigned leerDesdeArchBin(void **d, void *vfp, unsigned pos, void *params,void *params2);
                    ...
                    int li, int ls, void *params,void *params2)
{
    ...
    *p = (tNodoArbol*)malloc(sizeof(tNodoArbol));
    ...
    (*p)->tamInfo = leer(&(*p)->info, dataSet, media, params,params2);
    if((*p)->info == NULL)
    {
        free(*p);
        return ERROR_AR;
    ...
    r = cargarDesdeDatosOrdenadosRec(&(*p)->izq, dataSet,leer,
                                     li, media-1, params,params2);
    if(r != TODO_OK_AR)
    {
        return r;
    }
    return cargarDesdeDatosOrdenadosRec(&(*p)->der, dataSet,leer,
                                    ...
                                    unsigned tamReg,unsigned tamInd)
{
    ...
    r = cargarDesdeDatosOrdenadosRec(p, fp, leerDesdeArchBin,
        ...
        tArbol *indice)
{
    ...
    while(sacarDeColaCircular(cola, &nov, sizeof(tNovedad)))
    {
        ...
        {
            //actCuenta(archCuentas, ind.indiceRegistro, nov.monto);
